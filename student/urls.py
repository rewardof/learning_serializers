...
urlpatterns = [
    ...
    path('students/', views.SecondStudentApiView.as_view(), name='student2-list'),
    ...
    path('students_list_with_subject/', views.StudentSubjectsList.as_view(), name='students_list_with_subject')
]
